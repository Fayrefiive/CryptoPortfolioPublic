...
class __TwigTemplate_649e5012d5f4468befabfd3d80c846aeb3a6264208b49ff8824fcfff3c19fbc8 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <script>
        ...
        echo "\"; 
            ...
            \$(\".switch-button-checkbox\").on(\"change\", function() { 
                if (currencyChoose == \"primary\") { 
                    currency = \"";
        // line 181
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 181, $this->source); })()), "user", [], "any", false, false, false, 181), "getPrimaryCurrency", [], "any", false, false, false, 181), "getAcronym", [], "method", false, false, false, 181), "html", null, true);
        echo "\"; 
                    currencySymbol = \"";
        // line 182
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 182, $this->source); })()), "user", [], "any", false, false, false, 182), "getPrimaryCurrency", [], "any", false, false, false, 182), "getSymbol", [], "method", false, false, false, 182), "html", null, true);
        echo "\"; 
                }
                else { 
                    currency = \"";
        // line 185
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 185, $this->source); })()), "user", [], "any", false, false, false, 185), "getSecondaryCurrency", [], "any", false, false, false, 185), "getAcronym", [], "method", false, false, false, 185), "html", null, true);
        echo "\";
                    currencySymbol = \"";
        // line 186
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 186, $this->source); })()), "user", [], "any", false, false, false, 186), "getSecondaryCurrency", [], "any", false, false, false, 186), "getSymbol", [], "method", false, false, false, 186), "html", null, true);
        echo "\"; 
                }
                getAllCryptos();
            });
        ...
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("images/asset-card-white.jpg"), "html", null, true);
        echo ")'>\";
                        if (assets[0][\"total\"][asset].image == \"NO_DATA_FOUND\") { append += \"<img class='logo-plateform-card' src='";
        // line 257
        ...
        echo "' alt='crypto-logo-\" + assets[0][\"total\"][asset].name + \"'>\"; } 
                        else { append += \"<img class='logo-plateform-card' src='\" + assets[0][\"total\"][asset].image + \"' alt='crypto-logo-\" + assets[0][\"total\"][asset].name + \"'>\"; }
                ...
                for (let asset in assets[0][\"total\"]) {
                    ...
                    if (parseFloat(wallet_price).toFixed(2) != 0) {
                        if (asset == \"USD\" || asset == \"EUR\") {
                            ...
                            append += \"<td>\" + parseFloat(wallet_price).toFixed(2) + \" \" + currencySymbol + \"</td>\";
                        }
                        else { 
                            if (assets[0][\"total\"][asset].image == \"NO_DATA_FOUND\") {
                                append += \"<tr id='\" + assets[0][\"total\"][asset].id + \"' class='crypto-information'><td class='table-crypto-icon'><img src='/images/icons/not_found.png' alt='crypto-logo-not-found'></td><td><b>\" + assets[0][\"total\"][asset].name + \"</b></td>\";
                        ...
                        append += \"<td>\" + parseFloat(assets[0][\"total\"][asset].wallet).toFixed(2) + \"</td><td>\" + parseFloat(assets[0][\"total\"][asset].staking).toFixed(2) + \"</td>\";
...
";
    ...
    {
        return array (  500 => 257,  496 => 256,  456 => 219,  430 => 196,  417 => 186,  413 => 185,  407 => 182,  403 => 181,  340 => 121,  336 => 120,  330 => 117,  326 => 116,  311 => 105,  301 => 104,  284 => 96,  273 => 88,  267 => 85,  263 => 84,  259 => 83,  255 => 82,  251 => 81,  246 => 79,  241 => 77,  237 => 76,  232 => 74,  226 => 71,  220 => 68,  206 => 57,  194 => 48,  190 => 47,  175 => 35,  171 => 33,  160 => 30,  153 => 29,  149 => 28,  141 => 23,  134 => 19,  130 => 18,  120 => 11,  114 => 8,  111 => 7,  101 => 6,  80 => 4,  61 => 3,  38 => 1,);
    }
            ...
            function appendAssetsBlock() {
                ...
                for (let asset in assets[0][\"total\"]) {
                    ...
                    if (parseFloat(wallet_price).toFixed(2) != 0) {
                        ...
                        if (assets[0][\"total\"][asset].image == \"NO_DATA_FOUND\") { append += \"<img class='logo-plateform-card' src='{{ asset('images/icons/not_found.png') }}' alt='crypto-logo-\" + assets[0][\"total\"][asset].name + \"'>\"; } 
                        else { append += \"<img class='logo-plateform-card' src='\" + assets[0][\"total\"][asset].image + \"' alt='crypto-logo-\" + assets[0][\"total\"][asset].name + \"'>\"; }
                        append += \"<h4 class='text-center c-blue pt-3'>\" + assets[0][\"total\"][asset].name + \"</h4>\";
                        append += \"<hr class='hr-blue my-3'>\";
                        append += \"<div class='grid grid-cols-3'>\";
