...
/* menu.html.twig */
class __TwigTemplate_3ca426d2e7d2f42df19867eb0bcfca4b401f429183ee5fad05c3922e6c744f63 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        echo "\" class=\"menu-link text-center mb-4\">
...
";
    ...
    <a href=\"{{ path('app_home') }}\">
        <div id=\"{{ 'TITLE_HOME'|trans({}, 'message' ) }}\" class=\"menu-link text-center mb-4\">
            <i class=\"fas fa-home c-blue\"></i>
    ...
    {% if is_granted('ROLE_ADMIN') %}
        <a href=\"{{ path('app_admin') }}\">
            <div id=\"{{ 'TITLE_ADMIN'|trans({}, 'message' ) }}\" class=\"menu-link text-center mb-4\">
                <i class=\"fas fa-tools c-blue\"></i>
    ...
    <a href=\"{{ path('app_login') }}\">
        <div id=\"{{ 'TITLE_LOGIN'|trans({}, 'message' ) }}\" class=\"menu-link text-center mb-4\">
            <i class=\"fas fa-sign-in-alt c-blue\"></i>
    ...
    {% if app.user %}
        <a href=\"{{ path('app_account') }}\">
            <div id=\"{{ 'TITLE_MY_ACCOUNT'|trans({}, 'message' ) }}\" class=\"menu-link text-center mb-4\">
                <i class=\"fas fa-user c-blue\"></i>
                <span>{{ 'TITLE_MY_ACCOUNT'|trans({}, 'message' ) }}</span>
            </div>
        </a>
        <a href=\"{{ path('app_portfolio') }}\">
            <div id=\"{{ 'TITLE_PORTFOLIO'|trans({}, 'message' ) }}\" class=\"menu-link text-center mb-4\">
                <i class=\"fas fa-chart-bar c-blue\"></i>
    ...
    <a href=\"{{ path('app_help') }}\">
        <div id=\"{{ 'TITLE_HELP'|trans({}, 'message' ) }}\" class=\"menu-link text-center mb-4\">
            <i class=\"fas fa-question-circle c-blue\"></i>
...
", "menu.html.twig", "C:\\Users\\Utilisateur\\Documents\\GitHub\\CryptoPortfolio\\templates\\menu.html.twig");
    }
}
