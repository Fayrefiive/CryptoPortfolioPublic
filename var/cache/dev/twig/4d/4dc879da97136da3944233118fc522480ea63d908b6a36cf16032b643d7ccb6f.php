...
class __TwigTemplate_fbafb0ea0e07f953ecd84804ed79087f3c03f91a876d48ea0d3332f793f86d30 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo "DAM - ";
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("TITLE_ADMIN_MAX", [], "message"), "html", null, true);
...
{% block title %}DAM - {{ 'TITLE_ADMIN_MAX'|trans({}, 'message' ) }}{% endblock %}
 
{% block body %}
    <div class=\"panel-right-content\">
        <h1 class=\"c-blue text-3xl text-center mb-20\">{{ 'TITLE_ADMIN_MAX'|trans({}, 'message' ) }}</h1>
        <div id=\"admin-panel\">
            <div id=\"admin-header-button\">
                <div id=\"admin-hidden-button\">
...
{% endblock %}", "admin/index.html.twig", "/home/teo/dev/CryptoPortfolio/templates/admin/index.html.twig");
    }
}
